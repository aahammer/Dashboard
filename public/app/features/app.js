...
(function() {
  define(['angular', 'services/StateManagementService', 'services/CrossfilterService', 'controllers/TabListController', 'controllers/TabListController', 'controllers/TabListController', 'controllers/TabelListController', 'angular-ui-router', 'angular-ng-grid'], function(angular, StateService, DataService, SelectionCtrl, ModuleCtrl, MeasureCtrl, ItemTableCtrl) {
    var app;
    ...
    app.factory('DataService', DataService('DataSettings')).factory('StateService', StateService('StateSettings'));
    app.controller('SelectionCtrl', SelectionCtrl('SelectionSettings')).controller('ModuleCtrl', ModuleCtrl('ModuleSettings')).controller('MeasureCtrl', MeasureCtrl('MeasureSettings')).controller('ItemTableCtrl', ItemTableCtrl('ItemTableSettings'));
    app.config([
